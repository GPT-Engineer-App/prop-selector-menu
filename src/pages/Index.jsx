      ...
      <VStack spacing={4} width="100%">
        ...
        <Box width="100%">
          ...
          <HStack spacing={4}>
            ...
            <Image src={`/public/images/backdrops/${backdrop}_cartoon.jpg`} alt={`${backdrop} backdrop`} boxSize="50px" />
          </HStack>
        </Box>
          ...
          <CheckboxGroup value={balloons} onChange={handleBalloonsChange}>
            <VStack alignItems="flex-start">
              <HStack>
                ...
                <Image src="/public/images/balloons/red_cartoon.jpg" alt="Red balloon" boxSize="30px" />
              </HStack>
              <HStack>
                <Checkbox value="blue">Blue</Checkbox>
                <Image src="/public/images/balloons/blue_cartoon.jpg" alt="Blue balloon" boxSize="30px" />
              </HStack>
              <HStack>
                <Checkbox value="green">Green</Checkbox>
                <Image src="/public/images/balloons/green_cartoon.jpg" alt="Green balloon" boxSize="30px" />
              </HStack>
              <HStack>
                <Checkbox value="yellow">Yellow</Checkbox>
                <Image src="/public/images/balloons/yellow_cartoon.jpg" alt="Yellow balloon" boxSize="30px" />
              </HStack>
              <HStack>
                <Checkbox value="pink">Pink</Checkbox>
                <Image src="/public/images/balloons/pink_cartoon.jpg" alt="Pink balloon" boxSize="30px" />
              </HStack>
            </VStack>
          </CheckboxGroup>
        </Box>
            ...
            <HStack spacing={4}>
              {Array.from({ length: 10 }, (_, i) => (
                <VStack>
                  ...
                  <Image src={`/public/images/numbers/${i}_cartoon.jpg`} alt={`Number ${i} balloon`} boxSize="30px" />
                </VStack>
              ))}
            </HStack>
          </CheckboxGroup>
